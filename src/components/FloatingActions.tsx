...
export default function FloatingActions() {
  ...
  const WHATSAPP_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(t("whatsappMessage"))}`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="w-0 overflow-hidden whitespace-nowrap opacity-0 transition-[width,opacity,margin] duration-300 ease-out group-hover:ml-2.5 group-hover:w-[5.4rem] group-hover:opacity-100 group-focus-visible:ml-2.5 group-focus-visible:w-[5.4rem] group-focus-visible:opacity-100">{t("whatsappLabel")}</span>
      </a>
